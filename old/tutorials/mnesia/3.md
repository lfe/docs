...
> Paste the following table definitions into your LFE REPL:
...
The next step is defining the LFE records that Mnesia uses as the table definitions.
...
There are two types of types we will want to create:
